...
> ## 🌐 Live Demo
>
> 👉 **[Click here to see it live](https://anshmajumdar121.github.io/Cute-Letter-for-your-loving-once/)**
>
> ---
>
> ## 🚀 How to Customize
...
> >                9. | Rule | Why |
> > |------|-----|
> > | Keep quotes `" "` around text | JavaScript needs them |
> > | Keep commas `,` after each item | Separates list items |
> > | Don't delete `{ }` curly braces | Wraps each compliment object |
> > | Don't delete `[ ]` square brackets | Wraps the whole list |
> >
> > > If something breaks, check you didn't accidentally delete a quote or comma!
> > >
> > > ---
> > >
> > > ## 💖 Full Example
...
> > > ---
> > >
> > > <p align="center">Good luck! Hope they say <strong>YES! 💝</strong>strong></p>p>
<p align="center">Made with ❤️</p>p></strong>
